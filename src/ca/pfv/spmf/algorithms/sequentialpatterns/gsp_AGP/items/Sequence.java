...
public class Sequence {
    ...
    /**
     * It change the sequence identifier
     * @param integer 
     */
    ...
    /**
     * Obtains a list with the itemsets that compose the sequence
     * @return 
     */
    ...
    /**
     * It gets the ith itemset
     * @param index index of the ith itemset in which we are interested
     * @return 
     */
    ...
    /**
     * The time extension of the sequence. It is equal to the last itemset timestamp minus the first itemset timestamp
     * @return 
     */
