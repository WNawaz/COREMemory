...
public class IDListStandard_Map implements IDList {
    ...
    /**
     * It gets the map that codes tha appearances of the pattern in this IdList
     *
     * @return
     */
    ...
    /**
     * String representation of this IdList
     *
     * @return
     */
    @Override
     ...
     */
    @Override
    public void setAppearingIn(Pattern patron) {
        patron.setAppearingIn((BitSet)sequences.clone());
    }
}
