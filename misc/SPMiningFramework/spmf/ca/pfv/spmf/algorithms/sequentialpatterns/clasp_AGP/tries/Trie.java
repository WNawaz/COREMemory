...
public class Trie implements Comparable<Trie> {
     ...
     */
    public void setChild(int index, Trie hijo) {
        this.nodes.get(index).setChild(hijo);
    }
     ...
     * @param nodes 
     */
    public void setNodes(List<TrieNode> nodos) {
        this.nodes = nodos;
    }
     ...
     * @param node 
     */
    public void setNode(int index, TrieNode nodo) {
        nodes.set(index, nodo);
    }
     ...
     */
    public void setAppearingIn(BitSet presenteEn) {
        this.appearingIn = presenteEn;
    }
